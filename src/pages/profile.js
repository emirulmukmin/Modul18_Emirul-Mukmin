...
const Profile = () => {
    ...
    React.useEffect(() => {
        ...
        const verify = async () => {
          try {
            const response = await axios.post(`https://${process.env.REACT_APP_BACKEND_URL}/verify`, { token : token})
    ...
    const handleLogout = async () => {
        ...
        await axios.post(`https://${process.env.REACT_APP_BACKEND_URL}/logout`, {
